      ...
      <ul class="nav navbar-nav mainbar-nav">
        ...
        <li class="dropdown active">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="./ui-notifications.html"><i class="fa fa-asterisk nav-icon"></i> Update Product</a></li>
            <li><a href="./ui-sliders.html"><i class="fa fa-tasks nav-icon"></i> Delete Product</a></li>
